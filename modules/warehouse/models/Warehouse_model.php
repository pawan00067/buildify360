...
class Warehouse_model extends App_Model
{
	...
	public function get_pur_request($pur_order)
	{
		...
		foreach ($results as $key => $value) {
			...
			if ((float)$value['quantities'] - (float)$value['wh_quantity_received'] > 0) {
				...
				$list_item .= $this->create_goods_receipt_row_template($warehouse_data, 'newitems[' . $index . ']', $commodity_name, '', $quantities, $unit_name, $unit_price, $taxname, $lot_number, $date_manufacture, $expiry_date, $value['commodity_code'], $value['unit_id'], $value['tax_rate'], $value['tax_value'], $value['goods_money'], $note, $value['id'], $sub_total, '', $value['tax'], true, '', $value['description']);
	...
	public function get_new_commodity_code()
	{
		$prefix = get_item_option('item_prefix');
		$next_number = get_item_option('next_item_number');

		return $commodity_code = $prefix . $next_number;
	}
	 ...
	 * @return [type]                    
	 */
	public function create_goods_receipt_row_template($warehouse_data = [], $name = '', $commodity_name = '', $warehouse_id = '', $quantities = '', $unit_name = '', $unit_price = '', $taxname = '', $lot_number = '', $date_manufacture = '', $expiry_date = '', $commodity_code = '', $unit_id = '', $tax_rate = '', $tax_money = '', $goods_money = '', $note = '', $item_key = '', $sub_total = '', $tax_name = '', $tax_id = '', $is_edit = false, $serial_number = '', $description = '')
	{
