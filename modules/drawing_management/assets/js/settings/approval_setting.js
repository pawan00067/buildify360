	...
	(function(){
		...
		initDataTable('.table-approve', admin_url + 'drawing_management/approve_setting_table', false, false, fnServerParams, [0, 'desc']);
		...
		$('input[name="choose_when_approving"]').on('click', function(){
	...
	function edit(id){
		...
		addMoreVendorsInputKey = 1;
		$.post(admin_url+'drawing_management/get_approve_setting/'+id).done(function(response){
