									...
									<div class="col-md-12">
										<div class="picture-container pull-left">
											<div class="picture pull-left">
												<img src="<?php if (isset($staff_cover_image) && isset($image_exist) && isset($link_cover_image)) {
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<?php if (has_permission('hrm_hr_records', '', 'edit') || has_permission('hrm_hr_records', '', 'create')) { ?>
												<?php
												// Get selected team managers
												$selected_team = isset($member) ? explode(',', $member->team_manage) : [];
												?>
												...
												<div class="row">
													...
													<div class="col-md-5">
														...
														<select id="selected_team_manage" data-live-search="true" name="team_manage[]" class="form-control selectpicker" multiple>
															<?php foreach ($list_staff as $staff) { ?>
																<?php if (in_array($staff['staffid'], $selected_team)) { ?>
