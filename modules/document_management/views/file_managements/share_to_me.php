							...
							<div class="col-md-3 border-right">
								...
								<ul class="list-group list-group-flush list-group-custom" role="tablist">
									<li class="list-group-item list-group-item-action display-flex" data-toggle="list" role="tab">
										<a href="<?php echo admin_url('document_management/share_to_me'); ?>" class="w100 display-flex">
									...
									<li class="list-group-item list-group-item-action display-flex" data-toggle="list" role="tab">
										<a href="<?php echo admin_url('document_management/my_approval'); ?>" class="w100 display-flex">
