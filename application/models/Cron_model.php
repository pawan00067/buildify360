...
class Cron_model extends App_Model
{
    ...
    {
        if(empty(get_option('last_ticket_reminder_cron_run'))) {
            add_option('last_ticket_reminder_cron_run', date('Y-m-d'));
        }
        $last_ticket_reminder_cron_run = get_option('last_ticket_reminder_cron_run');
        if($last_ticket_reminder_cron_run == date('Y-m-d')) {
            ...
            update_option('last_ticket_reminder_cron_run', date("Y-m-d", strtotime("yesterday")));
        }
        die();
    }
