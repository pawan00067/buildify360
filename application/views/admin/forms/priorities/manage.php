                    ...
                    <div class="panel-body panel-table-full">
                        ...
                        <table class="table dt-table">
                            <thead>
                                ...
                                <th><?php echo _l('form_priority_dt_name'); ?></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tw-flex tw-items-center tw-space-x-3">
                                            ...
                                            <a href="<?php echo admin_url('forms/delete_priority/' . $priority['priorityid']); ?>"
                        ...
                        <?php } else { ?>
                        <p class="no-margin"><?php echo _l('no_form_priorities_found'); ?></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="priority" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('forms/priority')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo _l('form_priority_edit'); ?></span>
                    <span class="add-title"><?php echo _l('form_priority_add'); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_input('name', 'form_priority_add_edit_name'); ?>
                    </div>
                </div>
            </div>
...
function manage_form_priorities(form) {
